...
CREATE INDEX idx_song_personal_notes_version ON song_personal_notes(version);
...
-- ============================================================================
-- SECTION 8b: Song Notes RLS Policies
-- ============================================================================

-- song_personal_notes: Users can only access their own personal notes
...
-- song_note_entries: Band members can view band-visible entries
