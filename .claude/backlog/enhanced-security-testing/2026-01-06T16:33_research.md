...
> **2026-09-01 reconciliation:** Now **unblocked** — the ci-cd dependency shipped
> (`.github/workflows/ci.yml` runs lint/type-check/prettier/tests on PRs). This
> item is ready to start: add SAST scanning + RLS behavior tests + security pgTAP
> onto the existing CI. See `.claude/backlog/BACKLOG.md`.
