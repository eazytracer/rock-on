    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section>
          ...
          <div className="mt-4 bg-bg-1 border border-border-1 rounded-lg p-4 sm:p-6">
          ...
          <pre className="mt-4 p-3 bg-bg-0 border border-border-1 rounded text-xs text-ink-3 overflow-x-auto">
            {`<div className="bg-bg-1 border
