...
export function EventCreatePage() {
  ...
  return (
    <div
      data-testid="event-create-page"
      className="flex justify-center sm:pt-6"
    >
      {/* Desktop: presented as a centered modal card; mobile: full-bleed page. */}
      <div className="w-full max-w-lg sm:rounded-2xl sm:border sm:border-border-1 sm:bg-bg-2 sm:p-8 sm:shadow-xl">
        <button
          onClick={goBack}
